...
namespace DotBase
{
    class Constants
    {
        ...
        private Constants() {
            ...
            UNCERTAINITY_TEMPERATURE_VALUE = dbConnector.TworzTabeleDanych(String.Format("SELECT wartosc FROM Stale WHERE nazwa='{0}'", Constants.UNCERTAINITY_TEMPERATURE)).Rows[0].Field<double>(0);
