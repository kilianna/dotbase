...
call :check_vs %ProgramFiles%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin
call :check_vs %ProgramFiles%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin\amd64
...
call :check_vs %ProgramFiles(x86)%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin
call :check_vs %ProgramFiles(x86)%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin\amd64
...
call :check_vs %ProgramW6432%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin
call :check_vs %ProgramW6432%\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin\amd64
