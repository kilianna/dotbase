...
call :check_vs %ProgramFiles%\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin
call :check_vs %ProgramFiles%\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\amd64
